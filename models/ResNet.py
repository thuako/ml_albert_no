...
class ResNet_PReLU(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNet_PReLU, self).__init__()
        self.in_planes = 64
...
def ResNet_PReLU_18():
    return ResNet(BasicBlock_PReLU, [2, 2, 2, 2])


def ResNet_PReLU_34():
    return ResNet(BasicBlock_PReLU, [3, 4, 6, 3])


def ResNet_PReLU_50():
    return ResNet(Bottleneck_PReLU, [3, 4, 6, 3])
